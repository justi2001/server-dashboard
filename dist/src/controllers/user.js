...
const register = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        res.status(200).json({
            message: 'Register',
            data: Object.assign(Object.assign({}, newUser._doc), { token: yield (0, getAccsetoken_1.getAccesstoken)({
                    _id: newUser._id,
                    email: newUser.email,
                    rule: 1,
                }) }),
...
const login = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        res.status(200).json({
            message: 'Login successfuly!!!',
            data: Object.assign(Object.assign({}, user._doc), { token: yield (0, getAccsetoken_1.getAccesstoken)({
                    _id: user._id,
                    email: user.email,
...
const refreshToken = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const token = yield (0, getAccsetoken_1.getAccesstoken)({
            _id: id,
            email: user.email || '',
            rule: user.rule,
        });
